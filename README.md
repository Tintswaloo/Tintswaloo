...
|---------|-------------|------|------|
| **E-Commerce Website** | Responsive online shopping interface with product pages and clean UI. | [Live Demo](https://tintswaloo.github.io/Tintswaloo/) | [GitHub](https://github.com/tintswaloo/Tintswaloo) |
| **Online Store Interface** | Clean front-end layout emphasizing usability and responsive design. | [Live Demo](https://tintswaloo.github.io/Tintswaloo/) | [GitHub](https://github.com/tintswaloo/Tintswaloo) |
...
*(Replace screenshots with actual project images if available by using `![Alt Text](image_url)` inside the table)*
